...
/*	text		token	lexval */
	...
	"bst",		TZ,	PACK(60),	/* British Summer Time */
	...
	"fri",		IGNORE,	5,
	"friday",	IGNORE,	5,
	"fst",		DTZ,	PACK(60),	/* French Summer Time */
	"fwt",		TZ,	PACK(120),	/* French Winter Time  */
	...
	"ligt",		TZ,	PACK(600),	/* From Melbourne, Australia */
	"mar",		MONTH,	3,
	"march",	MONTH,	3,
	"may",		MONTH,	5,
	...
	"mez",		TZ,	PACK(60),	/* Middle Europe Zone */
	"mon",		IGNORE,	1,
	"monday",	IGNORE,	1,
	"mst",		TZ,	PACK(-420),	/* Mountain ST */
	"ndt",		DTZ,	PACK(-150),	/* Nfld. DT */
	"nft",		TZ,	PACK(-210),	/* Newfoundland ST */
	"nor",		TZ,	PACK(60),	/* Norway ST */
	"nov",		MONTH,	11,
	"novemb",	MONTH,	11,
